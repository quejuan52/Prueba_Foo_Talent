...
usuariosController.Guardar = function(request,response){
    ...
    usuariosModel.verificarEmail(post, function(verif){
        if(verif.continuar == "Si"){
            ...
            // $$$$$$$$$$$$$$$$ proceso de enviar el correo electronico $$$$$$$$$$$$$
            ...
            let mailOptions ={
                ...
                html: `<body>
                            ...
                            <div class="container">
                                ...
                                <a href="http://localhost:3000/activar/${post.email}/${post.azar}" class="activation-button">Activar Cuenta</a>
                                <div class="footer">
...
usuariosController.Listarid = function(request,response){
    ...
    usuariosModel.Listarid({_id:id},function(respuesta){
        response.json(respuesta)
    })
...
usuariosController.Eliminar = function(request,response){
    const { id } = request.params; 
    usuariosModel.Eliminar({_id:id}, function(actualiza){
